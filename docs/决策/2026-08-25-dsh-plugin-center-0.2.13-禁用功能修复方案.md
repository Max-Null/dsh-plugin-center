...
> 日期：2026-08-25
> 状态：已实施（本仓库 v0.2.13，2026-08-25；单元+组合验证 27/27 通过，未发布）
> 关联：SSiD 仓库 `docs/发版流程规范.md`（发布链）、本次 SSiD 排查（dsh-web-preview-panel 移出预制）
> 备注：本文档由 SSiD 仓库 `docs/决策/` 转移至此（2026-08-25）
...
## 5. 发布链（按 SSiD 仓库 `docs/发版流程规范.md`）
...
## 6. SSiD 侧已做动作（SSiD 仓库，2026-08-25）
